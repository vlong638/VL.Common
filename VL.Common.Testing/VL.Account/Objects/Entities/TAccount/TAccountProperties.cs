...
namespace VL.Common.Core.Object.VL.Account
{
    public class TAccountProperties
    {
        ...
        public static PDMDbProperty<String> AccountName { get; set; } = new PDMDbProperty<String>(nameof(AccountName), "AccountName", "账户名", false, PDMDataType.varchar, 20, 0, true);
        ...
        public static PDMDbProperty<String> Password { get; set; } = new PDMDbProperty<String>(nameof(Password), "Password", "密码", false, PDMDataType.varchar, 20, 0, true);
